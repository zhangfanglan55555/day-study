...
/**
 * 解决正则懒惰性，我们需要加全局修饰符g(这个是唯一的方法，而且不加g不管用什么办法捕获，也都
 * 不能把全部匹配的捕获到)
 */
let str = 'zhufeng2018peixun2019';
let reg = /\d+/g;
...
reg.myExecAll();//[2018,2019,2020,2021]


/**
 * str.match(reg) MATCH 实现了和 myExecAll处理的事情
 */
str.match(reg);//[2018,2019,2020,2021]
//正则不加G返回第一个匹配的即可，加了G，把所有匹配的内容都捕获到，最后统一存储到一个数组中返回。